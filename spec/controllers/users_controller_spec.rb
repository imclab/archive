...
describe UsersController do
  ...
  describe "GET 'index' as admin" do
    ...
    context 'as signed-in user' do
      ...
      context 'without admin rights' do
        it 'should redirect to sessions path' do
          controller_sign_in(user)
  ...
  describe 'destroy' do
    ...
    describe 'as signed-in user' do
      let(:signed_in_user) {
        create_user('signed_in@gmail.com')
      }

      context 'without admin rights' do
        it 'redirects to the sessions index' do
          controller_sign_in(signed_in_user)
      ...
      context 'with admin rights' do
        it 'successfully deletes the specified user and redirects to sessions_path' do
          signed_in_user.toggle!(:admin)
          controller_sign_in(signed_in_user)
